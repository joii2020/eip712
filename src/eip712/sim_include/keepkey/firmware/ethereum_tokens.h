...
#include "eip712/sim_include/keepkey/board/util.h"
...
#include "eip712/sim_include/keepkey/firmware/uniswap_tokens.def"
#include "eip712/sim_include/keepkey/firmware/ethereum_tokens.def"
  TokenIndexLast,
  TokenIndexFirst = 0
};
